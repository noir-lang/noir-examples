...
export function computeHashToCurve(message: Uint8Array, pk: Uint8Array): HashedPoint {
...
export function computeC_V2(nullifier: Point, rPoint: Point, hashedToCurveR: Point, hasher: any) {
...
export function computeS(rScalar: Uint8Array, sk: Uint8Array, c: string) {
  return (
    (((uint8ArrayToBigInt(sk) * hexToBigInt(c)) % CURVE.n) + uint8ArrayToBigInt(rScalar)) %
    CURVE.n
  ).toString(16);
}
