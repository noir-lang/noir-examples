...
uint256 constant VK_HASH = 0x05987a7f5b40d5f569153f66acf25b8adbb14c945fd79331578f8b90c148e4ed;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x14254161fdc0bca4da9aafdfdcaa7e4ab4df45358d3af168f0b541ad5d3a0904),
               y: uint256(0x0c7c367adb1079d53e47d198c6405e310975b5fc7d66ddfb33d702cefcc25929)
            }),
            qr: Honk.G1Point({ 
            ...
            qc: Honk.G1Point({ 
               x: uint256(0x206c5400dab6bb036200617be3b1cc87aaa1b8162de0af13e501614bff3ddd1c),
               y: uint256(0x02ab62187f68dcc40d9dbf8837f6db32e35dfa49893930848eb8586876ec3d03)
            }),
            ...
            s1: Honk.G1Point({ 
               x: uint256(0x0a4a996be5df18a02334737304f812aa28db3776aeba7920cec2d76f23d43e55),
               y: uint256(0x1ae154530af77f19eac0663c28c035129bd4aa977355db788806e2dcc4433873)
            }),
            s2: Honk.G1Point({ 
            ...
            s3: Honk.G1Point({ 
               x: uint256(0x1b3c0009706344f53c9f40efaa635307a7d506ebeb279eae9179575950589f97),
               y: uint256(0x2d4ab4cd35763fb817eb26ae1966795528d21d1358c43d8638a34ebb7489b5c1)
            }),
            s4: Honk.G1Point({ 
